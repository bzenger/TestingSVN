...
\begin{abstract}
    ...
    induce identical--—or at least similar—--forms of ischemia. To
    ...
    applied a hydraulic occlusion to the left anterior
    descending coronary artery. We varied the ischemic stress with
    two clinical protocols, the BRUCE and dobutamine stress
    tests. Our results suggest significant differences in the recorded
    electrical signal between stress
    mechanisms. Differences include the location, volume, and
    temporal development of ischemia throughout a stress episode. These
