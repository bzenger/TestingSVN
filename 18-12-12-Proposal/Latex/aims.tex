...
ischemia may be limited by incomplete understanding of the mechanisms
used to induce the stress (exercise or pharmacological agents) or the
limited diagnostic data acquired to visualize ischemia (12-lead electrocardiogram or ultrasound). These limitations
increase the risk for failed detection of deadly cardiac disease.
...
%Paragraph 1: The motivation for this research comes from the recent
%progress and the recurring need to...  Despite this progress and
%opportunity, there is a remaining challenge that must be overcome or a key
%step missing in understanding this system.  


%
%Paragraph 2: We propose to solve this problem using our amazing new
%technology and ideas. We have a main hypothesis about the mechanism of the
%system we study, which is that...  We will test this hypothesis using the
%techniques of a) build it, b) validate it, and c) apply to our preparation.

In order to achieve these goals, we propose the following specific aims: 
\vspace{-.1in} %This commands makes a negative space.
