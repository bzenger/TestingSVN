...
% provide a validation dataset to test detection methods.<Saving space--this
% should be in the significance.|]
...
% needles, each with 10 electrodes spaced at 1.5~mm along the shaft. A
% 247-lead sock electrode array provided the simultaneous epicardial
...
% [<Saving space and sticking to feasibility> This significant finding has
% motivated us to examine the unique three-dimensional and transient nature
% of ischemia created in the clinical setting and test several new
% hypotheses.]
...
% The combination of these metrics would
% confirm that the experimental model is accurately recording and controlling
...
%[<This next paragraph is sounding more like significance and we need to be
%careful not to waste space by repeating anything we have in one section at
%this point. I would move most of this content, merge and compress it, and
%then make any really crucial point in the previous paragraph.>
...
%[<This paragraph is too detailed for the space we have.  I would comment it
%out for now and then in a phrase or two, mention preliminary results in the
%next section> ; however, we are
%limited in statistical power with only two experimental results. We
%anticipate that increasing the number of interventions and experiments will
%neutralize any effect we have seen in our first two studies. Preliminary
%ischemic zone comparison can be seen in figure \ref{fig:dobutvspacing}. |]
...
interventions.
% We will compare relative differences between ischemic zones
% induced within experiments to control for vasculature and
...
%Dobutamine may cause ischemia from another mechanism in addition to
%increased heart rate and contractility. 

%[<Not sure this speculation adds a
%lot and might be risky...> We could foresee a significant coronary steal
%phenomenon occurring within the ischemic zone, which may cause more
%significant zones of ischemia to form.|]
...
%[|<I Love this content below but it, again, feels a lot like it should be
%in significance.  I think these J\&F sections in the approach need to be
%very short and punchy, harken back to the significance section, and just
%remind the reader of the essential motivation but focus more on feasibility
%than on justification. >]

% Few previous studies have attempted to implement ECGI as a viable method to
% detect myocardial ischemia. The first was from the mentor of this training
% grant \cite{RSM:Mac95} and while it showed promising results, these were
% limited to epicardial potentials and lacked consistency.  More recently,
% members of our group have created and applied a fundamentally novel
% mathematical formulation based on a new source model to localize the
% ischemic source within the myocardium. This advance also required novel use
% of numerical solvers that created very promising framework to detect acute
% myocardial ischemia at the level of the transmembrane potential
% (TMP).\cite{RSM:Wan2013,RSM:Wan2011a} The limitation of these studies is
% that they used simulated datasets and manually imposed `ischemic zones' in
% a myocardial geometry, from which they generated body-surface potentials at
% a single time instant to form the input data for the ECGI. These methods
% showed promise but were limited by the lack of ground truth datasets from
% experiments of suitable quality.
...
%[To implement an inverse model several initial
...
%
%An inverse model is simply the forward model in reverse. If we assume that
...
%
%| <I would compress and reorganize this previous next
%section, including the last two  paragraphs.  You have more detail here than
%you have space for and also than your reader will have patience for. Please
%comment out the previous section rather than deleting it as there is
%reusable text there, just too much of it (-:.  So
